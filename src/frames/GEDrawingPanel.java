...
public class GEDrawingPanel extends JPanel {
	...
	private KeyDrawinghandler drawingKeyHandler;
	...
	public GEDrawingPanel(){
		...
		drawingKeyHandler = new KeyDrawinghandler();
		cursors = new GECursorManager();
		addKeyListener(drawingKeyHandler);
	...
	private class KeyDrawinghandler extends KeyAdapter{
	...
	private class MouseDrawinghandler extends MouseInputAdapter{
		...
		public void mouseDragged(MouseEvent e) {
			if(currentState !=EState.Idle){
				if(key_shift == true){
					transformer.shift_transformer((Graphics2D)getGraphics(), e.getPoint(), key_shift);
				} else {
